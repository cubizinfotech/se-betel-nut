...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted">Update order information - {{ $order->order_number }}</p>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('product_name') is-invalid @enderror" 
                                   id="product_name" name="product_name" value="{{ old('product_name', $order->product_name) }}" required>
                            @error('product_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('lot_number') is-invalid @enderror" 
                                   id="lot_number" name="lot_number" value="{{ old('lot_number', $order->lot_number) }}">
                            @error('lot_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('rate') is-invalid @enderror" 
                                   id="rate" name="rate" value="{{ old('rate', $order->rate) }}" required>
                            @error('rate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('discounted_bag_weight') is-invalid @enderror" 
                                   id="discounted_bag_weight" name="discounted_bag_weight" value="{{ old('discounted_bag_weight', $order->discounted_bag_weight) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('packaging_charge') is-invalid @enderror" 
                                   id="packaging_charge" name="packaging_charge" value="{{ old('packaging_charge', $order->packaging_charge) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('hamali_charge') is-invalid @enderror" 
                                   id="hamali_charge" name="hamali_charge" value="{{ old('hamali_charge', $order->hamali_charge) }}" required>
                            @error('hamali_charge')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control datepicker @error('order_date') is-invalid @enderror" 
                                   id="order_date" name="order_date" value="{{ old('order_date', $order->order_date->format('Y-m-d')) }}" required>
                            @error('order_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control datepicker @error('due_date') is-invalid @enderror" 
                                   id="due_date" name="due_date" value="{{ old('due_date', $order->due_date->format('Y-m-d')) }}" required>
                            @error('due_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    @php
                        ...
                        $isPaid = $order->payments->sum('amount') >= $order->grand_amount;
                    @endphp
                    @if($isOverdue)
                ...
                <div class="mb-3">
                    ...
                    <span class="text-muted">₹{{ number_format($order->payments->sum('amount'), 2) }}</span>
                </div>
                
                <div class="mb-3">
                    <strong>Remaining Amount:</strong><br>
                    <span class="text-muted">₹{{ number_format($order->grand_amount - $order->payments->sum('amount'), 2) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow mt-3">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('payments.create', ['order_id' => $order->id]) }}" class="btn btn-outline-success">
