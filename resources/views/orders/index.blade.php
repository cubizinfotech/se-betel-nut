...
<div class="card shadow mb-4 position-relative">
    <div class="card-header d-flex justify-content-center align-items-center d-md-none position-relative">
        ...
        <button class="filter-toggle filter-icon" type="button" data-bs-toggle="collapse" data-bs-target="#ordersFilter" aria-expanded="false" aria-controls="ordersFilter" title="Toggle Filters">
            <i class="bi bi-funnel"></i>
        </button>
    </div>
    <div id="ordersFilter" class="card-body collapse d-md-block">
